...
//# sourceMappingURL=jquery-latest.min.js.map;
define('components/utils',["jquery"], function (e) {
  return {
...
($.fn.abreAba = function () {
  ...
  (function (t) {
    ...
    "function" == typeof define && define.amd
      ? define('components/useInteractions',["jquery"], t)
...
define('text!structure/index.html',[],function () { return '<div id="wrapper">\n    <!-- ===== HEADER ===== -->\n    <header id="new-header">\n        <div class="container h-100">\n            <div class="row h-100 justify-content-between justify-content-md-start align-items-center">\n\n                <div class="col-2 col-md-1 d-flex">\n                    <button class="bt-sumario"></button>\n                </div>\n\n                <div class="col-2 col-md-4 col-md-auto h-lg-100 d-flex mh-100 order-1 py-1 px-0 logo-container">\n                    <div class="logoMinCultura">\n                        <img src="./src/assets/images/custom/logo01.png"\n                            alt="Logotipo do Ministério da Cultura e Governo do Brasil, com o slogan \'Do lado do povo brasileiro\'.">\n                    </div>\n                    <div class="logo">\n                        <img src="./src/assets/images/custom/logoFundacaoItauEscola.svg"\n                            alt="Logo Fundação Itau - Escola">\n                    </div>\n                </div>\n\n                <div\n                    class="col-12 col-md d-flex flex-column align-content-start justify-content-center mh-100 order-3 order-md-2">\n                </div>\n\n                <div class="col-auto d-flex align-items-end order-2 order-md-3">\n                    <div class="row flex-column flex-lg-row align-items-end">\n                        <ul id="tools" class="col-auto">\n                            <li><button id="fontSize">Tamanho da Fonte</button></li>\n                            <li><button id="contrast">Alto Contraste</button></li>\n                            <li><button id="marcaTexto">Marca Texto</button></li>\n                            <li><button class="bt-insere-postit" id="postit">Anotações</button></li>\n                            <li><button id="bt-menu">Menu</button></li>\n                        </ul>\n                    </div>\n                </div>\n\n            </div>\n        </div>\n    </header>\n\n    <!-- ===== SUMÁRIO ===== -->\n    <div id="sumario" class="container p-0">\n        <div class="container">\n            <button id="bt-sumario">\n                <i>\n                    <img src="./src/assets/images/icos/ico-sumario.svg" alt="ícone sumário">\n                </i>\n                <span>Menu</span>\n            </button>\n\n            <ul class="sumario-content">\n                <button id="close-sumario" class="bt-sumario"></button>\n            </ul>\n        </div>\n    </div>\n\n    <!-- ===== MODAL MENU BASE ===== -->\n    <div class="modalMenuBase">\n        <div class="menuBaseHit"></div>\n        <div class="menuBaseBg"></div>\n\n        <div class="menuBaseContainer container p-0">\n            <div class="menuBaseHit"></div>\n\n            <div class="menuBaseContainerInfo">\n                <button class="close-menu"></button>\n\n                <div class="mdoInfo">\n                    <h2>Módulo</h2>\n                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing m tempore?</p>\n                </div>\n\n                <div class="infoMenu infoMenuPost" data-tool="postits">\n                    <img src="./src/assets/images/icos/ico-postits-list-2.svg" alt="ícone meus postits">\n                    <h4>Meus Postits [<span>0</span>]</h4>\n                </div>\n\n                <div class="infoMenu infoMenuDestaque" data-tool="highlight">\n                    <img src="./src/assets/images/icos/ico-highlight-list-2.svg" alt="ícone meus destaques">\n                    <h4>Meus Destaques [<span>0</span>]</h4>\n                </div>\n\n                <div class="progresso-aula">\n                    <h4>Nesta aula, você já viu</h4>\n                    <div class="ko-progress-circle" data-progress="50">\n                        <div class="ko-circle">\n                            <div class="full ko-progress-circle__slice">\n                                <div class="ko-progress-circle__fill"></div>\n                            </div>\n                            <div class="ko-progress-circle__slice">\n                                <div class="ko-progress-circle__fill"></div>\n                                <div class="ko-progress-circle__fill ko-progress-circle__bar"></div>\n                            </div>\n                        </div>\n                        <div class="ko-progress-circle__overlay">\n                            <h4 class="ko-progresso-text">0%</h4>\n                        </div>\n                    </div>\n                </div>\n\n            </div>\n        </div>\n    </div>\n\n    <!-- ===== PROGRESSO AULA ===== -->\n    <!-- <div id="progresso-aula" class="container p-0">\n        <div class="progresso-content">\n            <div class="txt-intro-progresso">Você já viu</div>\n            <div class="pct-progresso-aula">0%</div>\n        </div>\n    </div> -->\n\n    <!-- ===== TOOLS CONTENT ===== -->\n    <div id="tools-content" class="container p-0">\n        <div class="hit-tools hide"></div>\n        <div class="container">\n            <div class="tools-content empty inativo" data-tool="highlight">\n                <h4>Meus Destaques</h4>\n                <div class="empty-message">\n                    <p class="h2">Não há nada aqui.</p>\n                    <p>\n                        Selecione trechos que considerar importantes para auxiliar em seus estudos.\n                        Utilize a ferramenta marca-texto no menu superior e selecione o texto desejado.\n                    </p>\n                </div>\n                <button class="close-tools" data-button="#bt-highlights-list">Fechar</button>\n                <div class="highlight-content tools-content-list">\n                    <div class="cards"></div>\n                </div>\n            </div>\n\n            <div class="tools-content empty inativo" data-tool="postits">\n                <h4>Meus Postits</h4>\n                <div class="empty-message">\n                    <p class="h2">Não há nada aqui.</p>\n                    <p>\n                        Crie anotações para auxiliar em seus estudos.\n                        Utilize a ferramenta "Anotações" no menu superior para isso.\n                    </p>\n                </div>\n                <button class="close-tools" data-button="#bt-postits-list">Fechar</button>\n                <div class="postits-content tools-content-list">\n                    <div class="cards"></div>\n                </div>\n            </div>\n        </div>\n    </div>\n\n    <!-- ===== CONTENT BACKGROUND ===== -->\n    <div class="container bg-content">\n        <div class="detalhes-fundo"></div>\n    </div>\n\n    <!-- ===== MAIN CONTENT ===== -->\n    <div id="content" class="container"></div>\n\n    <!-- ===== SCROLL TO TOP ===== -->\n    <div class="seta-topo">\n        <button id="botao-topo">\n            <div class="txt-seta-topo">Voltar ao topo</div>\n        </button>\n    </div>\n\n    <!-- ===== FOOTER ===== -->\n    <footer>\n        <div class="container h-100 pt-1 locucao-player inativo" id="locucaoPlayer">\n\n            <div class="progresso-audio">\n                <div class="barra-progresso"></div>\n            </div>\n\n            <div class="row row-locucao justify-content-center justify-content-md-center flex-md-nowrap">\n                <div class="col-5 col-md-auto pipe-div flex-row-reverse order-6 order-md-1">\n                    <div class="item-locucao">\n                        <input id="ouvir-texto" type="checkbox" class="base-slider item-locucao-ouvir-texto">\n                        <label for="ouvir-texto"><span>Ouvir Texto</span></label>\n                    </div>\n                    <label class="txt-locucao">Ouvir Texto</label>\n                </div>\n\n                <div class="col-1 col-md-auto p-0 pipe-col order-2 order-md-2"></div>\n\n                <div class="col-5 col-md-auto pipe-div flex-md-row order-1 order-md-3">\n                    <button class="progresso-locucao-bt progresso-locucao-bt-menos"></button>\n                    <div class="txt-locucao progresso-locucao">00:00 / 00:00</div>\n                    <button class="progresso-locucao-bt progresso-locucao-bt-mais"></button>\n                </div>\n\n                <div class="col-auto d-none d-md-block p-0 pipe-col order-7 order-md-4"></div>\n\n                <div class="col-5 col-md-2 pipe-div order-4 order-md-5">\n                    <div class="item-locucao item-locucao-volume">\n                        <div class="base-slider">\n                            <div class="slider-volume">\n                                <div class="slidecontainer">\n                                    <button class="bt-transp-slider bt-transp-slider-left">Diminuir volume</button>\n                                    <input type="range" min="0" max="100" value="100" class="slider" id="volumeRange">\n                                    <button class="bt-transp-slider bt-transp-slider-right">Aumentar volume</button>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                    <label class="txt-locucao" for="slider-1">Volume</label>\n                </div>\n\n                <div class="col-1 col-md-auto p-0 pipe-col order-5 order-md-6"></div>\n\n                <div class="col-5 col-md-2 pipe-div velocidade-col order-3 order-md-7">\n                    <div class="item-locucao item-locucao-velocidade">\n                        <div class="base-slider">\n                            <div class="slider-velocidade">\n                                <div class="slidecontainer">\n                                    <button class="bt-transp-slider bt-transp-slider-left">Diminuir velocidade</button>\n                                    <input type="range" min="0" max="100" value="50" step="10" class="slider"\n                                        id="velocidadeRange">\n                                    <button class="bt-transp-slider bt-transp-slider-right">Aumentar velocidade</button>\n                                </div>\n                            </div>\n                        </div>\n                    </div>\n                    <label class="txt-locucao" for="slider-2">Velocidade do áudio</label>\n                </div>\n            </div>\n        </div>\n    </footer>\n</div>\n\n<!-- ===== POPUP MAPA ===== -->\n<div class="popup" data-tema="popup-mapa" id="mapa" data-largura="400"></div>';});

define('components/contentMap',["jquery", "components/utils"], function (r, u) {
  "use strict";
  var l,
    c = window.Sumario || {};
  function t() {
...
define('components/contentMenu',["jquery"], function ($) {
...
define('components/tools/postit',["jquery", "components/tools/toolcard"], function (n, t) {
  "use strict";
...
(function (global) {
  ...
  function refineRangeBoundaries(range) {
    ...
    var isInline = function (node) {
      return (
        ...
        ["I", "B", "EM", "STRONG", "SPAN", "A"].indexOf(node.tagName) !== -1
      );
    };

    // Refinamento do endContainer
    if (range.endOffset === 0) {
      ...
      if (range.endOffset < endContainer.nodeValue.length) {
        // Verifica se o nó de texto está dentro de um elemento inline.
        // Se estiver, não dividimos o nó de texto, mas sim movemos o endContainer para o pai inline.
        if (isInline(endContainer.parentNode)) {
          endContainer = endContainer.parentNode;
        } else if (range.endOffset > 0) {
          // Adicionado: Evita splitText se o offset for 0, o que criaria um nó vazio
    ...
    // Refinamento do startContainer
    if (startContainer.nodeType === NODE_TYPE.TEXT_NODE) {
      if (range.startOffset === startContainer.nodeValue.length) {
        goDeeper = false;
      } else if (range.startOffset > 0) {
        // Verifica se o nó de texto está dentro de um elemento inline.
        if (isInline(startContainer.parentNode)) {
          startContainer = startContainer.parentNode;
        } else if (range.startOffset < startContainer.nodeValue.length) {
          // Adicionado: Evita splitText se o offset for igual ao length, o que criaria um nó vazio
  ...
  var dom = function (el) {
    return /** @lends dom **/ {
      ...
      unwrap: function () {
        ...
        // Move todos os nós filhos para fora do 'el' (o wrapper)
        while (el.firstChild) {
          wrapper.insertBefore(el.firstChild, el);
        }

        dom(el).remove(); // Remove o 'el' (o wrapper)
  ...
  TextHighlighter.prototype.highlightRange = function (range, wrapper) {
    ...
    do {
      // Adicionado: Tratamento para nós de texto OU elementos inline que não são ignorados
      var isInlineElement =
        node.nodeType === NODE_TYPE.ELEMENT_NODE &&
        ["I", "B", "EM", "STRONG", "SPAN", "A"].indexOf(node.tagName) !== -1;
      ...
      if (
        goDeeper &&
        (node.nodeType === NODE_TYPE.TEXT_NODE || isInlineElement)
      ) {
        if (
          ...
          if (dom(this.el).contains(nodeParent) || nodeParent === this.el) {
            // Se for um nó de texto, envolvemos o nó de texto.
            // Se for um elemento inline, envolvemos o elemento inline inteiro.
  ...
  TextHighlighter.prototype.removeHighlights = function (element) {
    ...
    function removeHighlight(highlight) {
      ...
      // O unwrap retorna os nós filhos do highlight.
      // Se o highlight continha apenas um nó de texto, o unwrap retorna esse nó.
      // Se o highlight continha nós de texto e tags inline, o unwrap retorna todos eles.
      // O problema é que a mesclagem deve ser feita no primeiro nó de texto resultante
      // e depois no último, para garantir que os nós de texto adjacentes ao highlight
      // sejam mesclados.

      // Mescla o nó de texto anterior ao primeiro nó resultante do unwrap
      if (
        textNodes.length > 0 &&
        textNodes[0].nodeType === NODE_TYPE.TEXT_NODE
      ) {
        mergeSiblingTextNodes(textNodes[0]);
      }

      // Mescla o nó de texto posterior ao último nó resultante do unwrap
      if (
        textNodes.length > 0 &&
        textNodes[textNodes.length - 1].nodeType === NODE_TYPE.TEXT_NODE
      ) {
        mergeSiblingTextNodes(textNodes[textNodes.length - 1]);
      }
    }
  ...
  TextHighlighter.prototype.serializeHighlights = function () {
    ...
    highlights.forEach(function (highlight) {
      ...
      selectedTexts.push(highlight.textContent);
      /*hlDescriptors.push([
                //wrapper,
                "",
                "",
                //$(highlight).text(), //tirei para diminuir a string. Se der pau, favor voltar.
                hlPath.join(':'),
                offset,
                length
            ]);*/
    ...
    return {
      message: JSON.stringify(hlDescriptors),
      text: transformSpanToP(selectedTexts),
    };
  };
  ...
  TextHighlighter.prototype.deserializeHighlights = function (json) {
    ...
    function deserializationFn(hlDescriptor) {
      var hl = {
          ...
          wrapper: "<span class='highlighted' dh='true'></span>", //editado salut
          //text: hlDescriptor[1],
          path: hlDescriptor[0].split(":"),
          offset: hlDescriptor[1],
          length: hlDescriptor[2],
        },
        elIndex = hl.path.pop(),
        node = self.el,
        hlNode,
...
define("frameworks/TextHighlighter.min", function(){});

!(function (factory) {
  "use strict";

  if (typeof define === "function" && define.amd) {
    define('components/tools/highlight',["jquery"], factory);
...
(pipwerks.SCORM.isAvailable = function () {
  ...
  (pipwerks.SCORM.API.find = function (e) {
    for (
      var i = null,
        ...
        a = pipwerks.SCORM;
      !e.API && !e.API_1484_11 && e.parent && e.parent != e && t <= n;
    ...
    if (a.version)
      ...
      e.API_1484_11
        ? ((a.version = "2004"), (i = e.API_1484_11))
        : e.API && ((a.version = "1.2"), (i = e.API));
    return (
      i
        ? (r(s + ": API found. Version: " + a.version), r("API: " + i))
        : r(
            s +
              ": Error finding API. \nFind attempts: " +
              t +
  ...
  (pipwerks.SCORM.API.get = function () {
    ...
    return (
      i.parent && i.parent != i && (e = n(i.parent)),
      !e && i.top.opener && (e = n(i.top.opener)),
      !e &&
        i.top.opener &&
        i.top.opener.document &&
        (e = n(i.top.opener.document)),
      e ? (t.API.isFound = !0) : s("API.get failed: Can't find the API!"),
      e
    );
  }),
  ...
  (pipwerks.SCORM.connection.initialize = function () {
    var e = !1,
      i = pipwerks.SCORM,
      t = i.data.completionStatus,
      n = pipwerks.UTILS.trace,
      s = pipwerks.UTILS.StringToBoolean,
      r = i.debug,
      a = "SCORM.connection.initialize ";
    if ((n("connection.initialize called."), i.connection.isActive))
      n(a + "aborted: Connection already active.");
    else {
      var o = i.API.getHandle(),
        c = 0;
      if (o) {
        switch (i.version) {
          case "1.2":
        ...
        if (e)
          if (((c = r.getCode()), null !== c && 0 === c)) {
            if (
              ((i.connection.isActive = !0),
              i.handleCompletionStatus && ((t = i.status("get")), t))
            )
              switch (t) {
                case "not attempted":
                case "unknown":
                  i.status("set", "incomplete");
              }
          } else
            (e = !1),
              n(
            ...
            n(
              null !== c && 0 !== c
                ? a +
                    ...
                    " \nError info: " +
                    r.getInfo(c)
                : a + "failed: No response from server."
            );
      } else n(a + "failed: API is null.");
    }
    return e;
  }),
  (pipwerks.SCORM.connection.terminate = function () {
    var e = !1,
      i = pipwerks.SCORM,
      t = i.data.exitStatus,
      n = i.data.completionStatus,
      s = pipwerks.UTILS.trace,
      r = pipwerks.UTILS.StringToBoolean,
      a = i.debug,
      o = "SCORM.connection.terminate ";
    if (i.connection.isActive) {
      var c = i.API.getHandle(),
        p = 0;
      if (c) {
        if (i.handleExitMode && !t)
          if ("completed" !== n && "passed" !== n)
            switch (i.version) {
              case "1.2":
                e = i.set("cmi.core.exit", "suspend");
                break;
              case "2004":
                e = i.set("cmi.exit", "suspend");
            }
          else
            switch (i.version) {
              case "1.2":
                e = i.set("cmi.core.exit", "logout");
                break;
              case "2004":
                e = i.set("cmi.exit", "normal");
            }
        if (((e = i.save()), e)) {
          switch (i.version) {
            case "1.2":
    ...
    } else s(o + "aborted: Connection already terminated.");
    return e;
  }),
  (pipwerks.SCORM.data.get = function (e) {
    ...
    if (t.connection.isActive) {
      ...
      if (a) {
        ...
        if (((o = s.getCode()), "" !== i || 0 === o))
          switch (e) {
            case "cmi.core.lesson_status":
            case "cmi.completion_status":
              t.data.completionStatus = i;
              break;
            case "cmi.core.exit":
            case "cmi.exit":
              t.data.exitStatus = i;
          ...
          n(r + "failed. \nError code: " + o + "\nError info: " + s.getInfo(o));
      } else n(r + "failed: API is null.");
    } else n(r + "failed: API connection is inactive.");
    return n(r + " value: " + i), String(i);
  }),
  (pipwerks.SCORM.data.set = function (e, i) {
    var t = !1,
      n = pipwerks.SCORM,
      s = pipwerks.UTILS.trace,
      r = pipwerks.UTILS.StringToBoolean,
    ...
    if (n.connection.isActive) {
      var c = n.API.getHandle(),
        p = 0;
      if (c) {
        switch (n.version) {
          case "1.2":
            t = r(c.LMSSetValue(e, i));
            break;
          case "2004":
            t = r(c.SetValue(e, i));
        }
        t
          ? ("cmi.core.lesson_status" !== e && "cmi.completion_status" !== e) ||
            (n.data.completionStatus = i)
          : s(
              o +
                "failed. \nError code: " +
                p +
  ...
  (pipwerks.SCORM.data.save = function () {
    var e = !1,
      i = pipwerks.SCORM,
      t = pipwerks.UTILS.trace,
      n = pipwerks.UTILS.StringToBoolean,
      s = "SCORM.data.save failed";
    if (i.connection.isActive) {
      ...
      else t(s + ": API is null.");
    } else t(s + ": API connection is inactive.");
    return e;
  }),
  (pipwerks.SCORM.status = function (e, i) {
    var t = !1,
      n = pipwerks.SCORM,
      s = pipwerks.UTILS.trace,
      r = "SCORM.getStatus failed",
      a = "";
    if (null !== e) {
      switch (n.version) {
        case "1.2":
      ...
      switch (e) {
        ...
        case "set":
          null !== i
            ? (t = n.data.set(a, i))
            : ((t = !1), s(r + ": status was not specified."));
          break;
        default:
          (t = !1), s(r + ": no valid action was specified.");
      }
    } else s(r + ": action was not specified.");
    return t;
  }),
  (pipwerks.SCORM.debug.getCode = function () {
    ...
    if (i)
      switch (e.version) {
        case "1.2":
          n = parseInt(i.LMSGetLastError(), 10);
          break;
        case "2004":
          n = parseInt(i.GetLastError(), 10);
      }
    else t("SCORM.debug.getCode failed: API is null.");
    return n;
  }),
  (pipwerks.SCORM.debug.getInfo = function (e) {
    var i = pipwerks.SCORM,
      t = i.API.getHandle(),
      n = pipwerks.UTILS.trace,
      s = "";
    if (t)
      switch (i.version) {
        case "1.2":
          s = t.LMSGetErrorString(e.toString());
          break;
        case "2004":
          s = t.GetErrorString(e.toString());
      }
    else n("SCORM.debug.getInfo failed: API is null.");
    return String(s);
  }),
  (pipwerks.SCORM.debug.getDiagnosticInfo = function (e) {
    ...
    if (t)
      switch (i.version) {
        case "1.2":
          s = t.LMSGetDiagnostic(e);
          break;
        case "2004":
          s = t.GetDiagnostic(e);
      }
    else n("SCORM.debug.getDiagnosticInfo failed: API is null.");
    return String(s);
  }),
  ...
  (pipwerks.UTILS.trace = function (e) {
    pipwerks.debug.isActive && window.console && window.console.log;
  });

define("frameworks/SCORM_API_wrapper.min", function(){});
...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        define('frameworks/js.cookie',factory);
...
define('components/useScorm',["jquery", "frameworks/SCORM_API_wrapper.min", "frameworks/js.cookie"], function (
  i,
  t,
  s
) {
...
define("components/tools/header", function(){});
...
define("frameworks/fontawesome", function(){});
...
define('app/page',["jquery", "frameworks/keen-slider.min"], function ($, KeenSlider) {
  function Page() {
    this.listaTelas = [];
  }
...
define("frameworks/imagesloaded.pkgd.min", ["jquery"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.imagesLoaded;
    };
}(this)));
...
define("../scripts/app/boot", function(){});
