define([
  ...
  var l = window.Tools || {};
  function e(t, o) {
    0 < o ? (t.removeClass("d-none"), t.html(o)) : t.addClass("d-none");
  }
  ((l = function (t, o) {
    var i = this,
      s = {
    ...
    (this.settings = n.extend(!0, s, o)),
      ...
      n(t).PDF(o.wrapper),
      e(n("#bt-highlights-list .tool-count"), i.settings.highlights.length),
      ...
      n("#tools-content .bt-tools-content").on("click", function () {
